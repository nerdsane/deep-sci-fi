...
# === LLM vs LLM Collaborative Consultation System ===
...
def get_llm_debate_meta_analysis_prompt_a(use_case: str, num_directions: int, context_value: str, source_content: str) -> str:
    ...
    return f"""You're discussing research directions for {use_case} with another expert. Your task is to propose {num_directions} distinct research directions.
...
def get_llm_debate_meta_analysis_prompt_b(use_case: str, num_directions: int, conversation_context: str) -> str:
    ...
    return f"""You're discussing research directions for {use_case} with another expert. Here's the conversation so far:
...
def get_llm_debate_meta_analysis_continue_a(use_case: str, num_directions: int, conversation_context: str) -> str:
    ...
    return f"""Continue the discussion about research directions for {use_case}. Here's the conversation so far:
...
def get_llm_debate_tournament_prompt_a(use_case: str, scenario_1_content: str, scenario_2_content: str) -> str:
    ...
    return f"""You're helping evaluate two {use_case} options with another expert. Please review Option 1 and make a case for why it might be the better choice:
...
def get_llm_debate_tournament_prompt_b(use_case: str, scenario_2_content: str, conversation_context: str) -> str:
    ...
    return f"""You're helping evaluate two {use_case} options with another expert. Here's what Expert A said about Option 1:
...
def get_llm_debate_tournament_final_a(conversation_context: str) -> str:
    ...
    return f"""Based on the discussion so far, please make your final assessment of which option is better:
...
def get_llm_debate_tournament_final_b(conversation_context: str) -> str:
    ...
    return f"""Based on the full discussion, please make your final assessment of which option is better:
