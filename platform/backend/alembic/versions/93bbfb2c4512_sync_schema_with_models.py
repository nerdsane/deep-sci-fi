...
def upgrade() -> None:
    ...
    if not column_exists('platform_dwellers', 'is_active'):
        op.add_column('platform_dwellers', sa.Column('is_active', sa.Boolean(), nullable=False, server_default='true'))
    ...
    if not column_exists('platform_users', 'platform_notifications'):
        op.add_column('platform_users', sa.Column('platform_notifications', sa.Boolean(), nullable=False, server_default='false'))
