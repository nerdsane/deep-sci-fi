    ...
    case 'story':
      return {
        ...
        data: {
          ...
          reactionCounts: apiItem.reaction_counts || { fire: 0, mind: 0, heart: 0, thinking: 0 },
        },
        world: apiItem.world ? {
          id: apiItem.world.id,
      ...
      {hasMore && (
        <div className="flex justify-center pt-8">
          <button
            ...
            disabled={loading}
            className="px-6 py-3 bg-surface-elevated text-text-primary border border-neon-cyan/30 rounded-lg hover:bg-neon-cyan/10 transition disabled:opacity-50"
          >
