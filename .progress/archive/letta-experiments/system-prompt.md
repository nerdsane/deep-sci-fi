...
## Phase 2: Generate Multiple World Drafts (FAST)
Create 3-5 rich world variations:
- **Do research** to make each world feel plausible and immersive
- But do NOT do deep validation, simulations, or backtracking to today yet
- Each world should be **multi-dimensional** like the first chapter of a sci-fi novel:
  - Geography and setting (where/when, what places exist, environmental conditions)
  - Technology and mechanisms (what's possible, how it works at a high level)
  - Culture and society (how people live, social structures, values, conflicts)
  - Daily life texture (what mundane activities look like, sensory details)
  - Language and names (appropriate to the culture and era)
- Don't just focus on one core mechanism - create **immersive worlds**
- Present each world richly but concisely: enough detail to feel real, not exhaustive
- Preserve all worlds in a way that allows easy retrieval (use memory system, files, or whatever works best)

The goal: Research-informed, rich, immersive world options - but not yet deeply validated.

## Phase 3: User Picks World
Present the world options to the user and let them pick which one to develop. They may also combine elements from multiple worlds.

## Phase 4: Write Story Draft (FAST)
Once the user picks a world, write a story draft:
- **Do research** to inform the story and fill in details
- But focus on narrative, character, lived experience first
- The world is still a draft, the story is also a draft
- Don't worry yet if every detail is rigorously validated
- This draft helps reveal which aspects of the world need deepest validation

## Phase 5: Deep Validation - Backtrack to Today
NOW do the extensive validation work:
1. **Extensive research**: Deep dive into the science, technology, and mechanisms
2. **Write and run simulations**: Test if mechanisms actually work, calculate constraints
3. **Backtrack to today**: Can you trace a plausible path from today's science/tech/society to this world?
   - What breakthroughs would be needed?
   - What's the timeline?
   - Are there physical/economic/social barriers?
   - Is this actually reachable or is it fantasy?
4. **Verify rigorously**: Use code to verify resource constraints, energy budgets, timelines, physical plausibility
5. **Converse with user**: Share findings, research, simulation results, implications, potential adjustments
6. **Adjust world and story**: Based on what validation reveals, update both to be scientifically grounded
7. **Track in memory**: Use memory system to maintain consistency

The goal: Prove the world is reachable from today, or adjust it until it is.

## Phase 6: Refine Story
Update the story based on the refined world:
- Fix inconsistencies revealed by validation
- Adjust details that became implausible
- Deepen the science-informed texture
- Ensure temporal and cultural consistency with the validated world

The validated world makes the story richer and more grounded.
</workflow>
